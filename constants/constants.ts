...
export const DOLLAR_DESCRIPTIONS: Record<TCasa, string> = {
  oficial:
    'Es el tipo de cambio establecido por el Banco Central de la República Argentina (BCRA). Se usa para operaciones legales y comercio exterior, pero está sujeto a restricciones y regulaciones.',
  blue: 'Es el tipo de cambio informal que se negocia en el mercado paralelo, sin intervención del BCRA. Suele ser más alto que el oficial debido a la demanda de dólares fuera del sistema regulado.',
  ...
  contadoconliqui:
    'Es un tipo de cambio legal que permite comprar dólares en el exterior mediante la compra y venta de bonos o acciones entre mercados locales e internacionales. Es usado por empresas e inversores para girar divisas al extranjero.',
  ...
  cripto:
    'Es el precio del dólar basado en la compra de criptomonedas (como USDT o DAI) con pesos. Suele estar en línea con el blue o el CCL, y permite acceder a dólares sin restricciones oficiales.',
